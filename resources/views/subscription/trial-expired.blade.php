                ...
                <div class="card shadow-lg border-0 rounded-4"
                    ...
                    <div class="card-body text-center p-5 text-white">
                        ...
                        <p class="mb-4" style="font-size: 1.1rem; color: rgba(255,255,255,0.8);">
                            Your trial period has ended. To continue using all features, please add your payment
                            method.
                        </p>
                        ...
                        <a href="{{ route('company.dashboard.settings.bank-info', ['company' => auth()->user()->company->sub_domain]) }}"
                            ...
                            <i class="bi bi-credit-card-2-front-fill me-2"></i> Add Payment Method
                        </a>
                    </div>
                </div>

                <div class="text-center mt-3">
                    <small class="text-white-50">If you do not add your payment method, your access will remain
                        restricted.</small>
                </div>
            </div>
        </div>
