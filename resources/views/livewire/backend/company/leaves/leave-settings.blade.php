<div class="card">
    <div class="card-body">
        <form class="row g-3" wire:submit.prevent="save">
            ...
            <!-- Employee Select -->
            <div class="mb-3">
                <label for="employeeSelect" class="form-label fw-medium">
                    Select Employee <span class="text-danger">*</span>
                </label>

                <div class="dropdown">
                    <button class="btn btn-light form-select text-start w-100" type="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                    ...
                    <ul class="dropdown-menu w-100" style="max-height:200px; overflow-y:auto;">
                        @foreach ($employees as $employee)
                            <li>
                                <a class="dropdown-item" wire:click="selectEmployee({{ $employee->user_id }})">
                                    {{ $employee->full_name }}
