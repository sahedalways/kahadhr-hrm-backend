<div>
            ...
            <div class="row g-4">
                @forelse ($duties as $duty)
                    @php
                        ...
                        // Use the full description as is (with HTML) for rendering
                        $fullDescription = $duty->description;
                        // Create a truncated version (strip tags, then limit)
                        $truncatedDescription = Str::limit(strip_tags($duty->description), 120);
                    @endphp
                        ...
                        <div class="card h-100 border-0 shadow-sm hover-card rounded-4 overflow-hidden">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="description-wrapper mb-3"
                                    ...
                                    <div class="card-text text-muted small mb-2 full-description-content"
                                         x-show="expanded"
                                         x-cloak>
                                        {!! $fullDescription !!}
                                    </div>
                                    ...
                                    <div class="file-preview-modern rounded-3 p-3 mb-3">
                                        @php
                                            ...
                                            $fileSize = Storage::disk('public')->exists($duty->file_path)
                                                ? number_format(
                                                        Storage::disk('public')->size($duty->file_path) / 1024,
                                                        1,
                                                    ) . ' KB'
                                                : 'Unknown size';
                                        @endphp
                                        ...
                                        @elseif(in_array($ext, ['pdf']))
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div>
                                                        <small class="text-dark fw-semibold d-block">Duty
                                                            Document</small>
                ...
                @empty
                    <div class="col-12">
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted small">No reporting or reporting duties match your search criteria.
                            </p>
                        </div>
                    </div>
                @endforelse
    ...
    {{-- Add a bit of CSS to prevent FOUC while Alpine initialises --}}
    <style>
        [x-cloak] {
