                ...
                <div class="col-12">
                    <div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="card shadow-sm border-0 position-relative">
                                        <div class="card-body py-3">
                                            ...
                                            <div class="dropdown position-absolute top-0 end-0 mt-2 me-2" wire:ignore>
                                                <button class="btn btn-sm px-md-3 px-2" type="button" data-bs-toggle="dropdown"
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('company.dashboard.employees.details', [
                                                                'company' => app('authUser')->company->sub_domain,
                                                                'id' => $employee->id,
                                                            ]) }}">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#"
                                                            ...
                                                            <i
                                                                class="fas fa-toggle-{{ $employee->is_active ? 'off text-danger' : 'on text-success' }} fa-fw me-2"></i>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#"
                                                            wire:click.prevent="assignAAdmin({{ $employee->id }})">
                                                            <i class="fas fa-user-shield fa-fw me-2"></i> Assign A-Admin
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item text-danger" href="#"
                                                            wire:click.prevent="$dispatch('confirmDelete', {{ $employee->id }})">
                                                            <i class="fas fa-trash-alt fa-fw me-2"></i> Delete Employee
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            {{-- Card Content --}}
                                            {{-- On mobile, the main card content should stack vertically. On medium/large screens, it remains horizontal. --}}
                                            <div
                                                class="d-flex flex-column flex-md-row align-items-md-center justify-content-between flex-wrap gap-3">

                                                {{-- Left Section: Avatar, Name, Job Title --}}
                                                <div class="d-flex align-items-center mb-3 mb-md-0">
                                                    {{-- Avatar/Initials --}}
                                                    <div class="bg-primary text-white rounded-circle d-flex justify-content-center align-items-center me-3"
                                                        style="width: 40px; height: 40px; font-size: 16px;">
                                                        {{ strtoupper(substr($employee->f_name ?? 'N', 0, 1) . substr($employee->l_name ?? 'A', 0, 1)) }}
                                                    </div>
                                                ...
                                                {{-- Right/Middle Section: Data Fields --}}
                                                {{-- Make this section stack on extra small/small screens (d-flex flex-column) and wrap on medium/large (flex-md-row flex-wrap) --}}
                                                <div
                                                    class="d-flex flex-wrap flex-md-nowrap align-items-start justify-content-start flex-grow-1">

                                                    {{-- Team --}}
                                                    <div class="text-start text-md-center me-4 me-lg-5 mb-2 mb-sm-0"
                                                        style="min-width: 100px;">
                                                        <div class="text-muted small text-uppercase fw-bold">Team</div>
                                                        <div class="text-dark">{{ $employee->team->name ?? 'N/A' }}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="text-start text-md-center me-4 me-lg-5 mb-2 mb-sm-0"
                                                        ...
                                                        <div class="text-muted small text-uppercase fw-bold">Email
                                                        </div>
                                                        <div class="text-success text-truncate"
                                                            onclick="copyToClipboard('{{ $employee->email ?? '' }}')"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="Click to copy: {{ $employee->email ?? 'N/A' }}"
                                                            style="cursor: pointer;">
                                                            {{ $employee->email ?? 'N/A' }}
                                                        </div>
                                                    </div>

                                                    {{-- Working Status (Non-clickable display) --}}
                                                    <div class="text-start text-md-center me-4 me-lg-5 mb-2 mb-sm-0"
                                                        style="min-width: 80px;">
                                                        <div class="text-muted small text-uppercase fw-bold">Status
                                                        </div>
                                                        <div class="fw-bold">
                                                            {!! statusBadgeTwo($employee->is_active) !!}
                                                        </div>
                                                    ...
                                                    {{-- Verification Status --}}
                                                    <div class="text-start text-md-center mb-2 mb-sm-0"
                                                        style="min-width: 100px;">
                                                        <div class="text-muted small text-uppercase fw-bold">Verified
                                                        </div>
                                                        @if (!$employee->verified && !$employee->invite_token)
                                                            <button class="badge badge-primary badge-xs border-0"
                                                                wire:click="sendVerificationLink({{ $employee->id }})"
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="card card-body text-center shadow-sm border-0">
                                        No employees found
                                    </div>
                                </div>
                            @endforelse
