     @push('styles')
         <link href="{{ asset('assets/css/yearly-leave.css') }}"
               rel="stylesheet" />
     @endpush
                                             ...
                                             @for ($day = 1; $day <= $daysInMonth; $day++)
                                                 @php
                                                     ...
                                                     if ($hasLeave) {
                                                         ...
                                                         $endDate = \Carbon\Carbon::parse($leaveOnDate['end'])->format(
                                                             'd M, Y',
                                                         );
                                                         $duration =
                                                             \Carbon\Carbon::parse($leaveOnDate['start'])->diffInDays(
                                                                 \Carbon\Carbon::parse($leaveOnDate['end']),
                                                             ) + 1;
