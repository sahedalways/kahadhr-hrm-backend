<div>
    ...
    <div class="row mb-3 align-items-center justify-content-between">
        ...
        <div class="col-auto d-flex gap-2">
            <!-- Export buttons -->
            <button wire:click="exportAttendance('pdf')" class="btn btn-sm btn-white text-primary">
                <i class="fa fa-file-pdf me-1"></i> PDF
            </button>
            <button wire:click="exportAttendance('excel')" class="btn btn-sm btn-white text-success">
                <i class="fa fa-file-excel me-1"></i> Excel
            </button>
            <button wire:click="exportAttendance('csv')" class="btn btn-sm btn-white text-info">
    ...
    <div class="row mb-3 align-items-end mt-4">
        ...
        <div class="col-md-2 d-flex justify-content-end">
            <div class="w-100">
                <label for="sortOrder" class="form-label fw-bold">Sort</label>
                <select id="sortOrder" class="form-select form-select-lg" wire:change="handleSort($event.target.value)">
