...
<div>
    <div class="row g-3 align-items-center justify-content-between mb-4">
        ...
        <!-- LEFT: Title -->
        <div class="col-auto">
            <h5 class="fw-500 text-primary m-0">Training Management</h5>
        </div>
                    ...
                    <table class="table table-bordered mt-0 text-center align-middle">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="10"
                                        class="text-center p-3">No trainings found</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit"
                                ...
                                <span wire:loading.remove
                                      wire:target="saveTraining">Save Training</span>
                            </button>
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit"
                                ...
                                <span wire:loading.remove
                                      wire:target="updateTraining">Save Training</span>
                            </button>
                    ...
                    @if ($training && $training->file_path)
                        <div class="mb-4">
                            ...
                            <div class="p-3 bg-light rounded shadow-sm"
                                ...
                                @elseif($training->content_type === 'file')
                                    <a href="{{ asset('storage/' . $training->file_path) }}"
                                       target="_blank"
                                            ...
                                            <td>
                                                @if ($assignment->proof_file)
                                                    <a href="{{ asset('storage/' . $assignment->proof_file) }}"
                                                       target="_blank"
                                                       class="badge bg-info text-white">View</a>
                                                @else
...
<script>
    window.addEventListener('show-training-modal', function() {
        let modalEl = document.getElementById('viewReport');
        if (!modalEl) return;
