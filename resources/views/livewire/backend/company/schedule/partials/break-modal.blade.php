        ...
        <div class="modal-content">
            ...
            @if (!$showAddBreakForm)
                <div class="modal-header border-0 pe-4 position-relative justify-content-end">
                    <h5 class="modal-title fs-6 text-secondary mx-auto"
                        id="customAddBreakModalLabel">
            ...
            <div class="modal-body text-center pt-2 mt-5">
                            ...
                            <div class="row g-2 align-items-end mb-3 text-center add-break">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text"
                                           ...
                                           wire:model.live="newBreaks.{{ $index }}.name"
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-outline-secondary dropdown-toggle w-100 text-center"
                                ...
                                <div class="col-2">
                                    ...
                                    <button wire:click="removeBreakRow({{ $index }})"
                                            type="button"
                ...
                <div class="dropdown d-inline-block">
                    <button class="btn btn-primary dropdown-toggle custom-break-dropdown-btn"
                            type="button"
                            id="customAddBreakDropdown"
                            data-bs-toggle="dropdown"
                            aria-expanded="false">
                        Add break
                    </button>
                    ...
                    <ul class="dropdown-menu shadow-sm custom-break-dropdown-menu"
                        aria-labelledby="customAddBreakDropdown"
            ...
            <div class="modal-footer border-0 p-3 justify-content-end">
                <button type="button"
                        ...
                        wire:click="confirmBreaksAndSave"
                        wire:loading.attr="disabled"
                        wire:target="confirmBreaksAndSave">
                    <span wire:loading.remove
                          wire:target="confirmBreaksAndSave">Confirm</span>
                    <span wire:loading
                          wire:target="confirmBreaksAndSave">
