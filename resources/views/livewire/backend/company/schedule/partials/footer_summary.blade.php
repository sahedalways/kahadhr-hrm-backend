...
<div class="unique-summary-wrapper mt-auto border-top bg-white py-4 px-3 rounded-bottom">
    ...
    <div class="d-flex align-items-center mb-3 px-1">
        <div class="flex-grow-1 border-bottom me-3"
             style="opacity: 0.1;"></div>
        <h6 class="text-muted fw-bold text-uppercase mb-0 small"
            style="letter-spacing: 1px;">
            {{ $viewMode == 'monthly' ? 'Monthly Overview' : 'Weekly Overview' }}
        </h6>
        <div class="flex-grow-1 border-bottom ms-3"
             style="opacity: 0.1;"></div>
    </div>
    ...
    <div class="row g-3">
        <div class="col-md-4">
            <div class="unique-summary-card d-flex align-items-center p-3 shadow-sm border rounded">
                ...
                <div>
                    <div class="unique-summary-value fw-bold fs-4 text-dark">{{ $summary['shifts'] ?? 0 }}</div>
        ...
        <div class="col-md-4">
            <div class="unique-summary-card d-flex align-items-center p-3 shadow-sm border rounded">
                ...
                <div>
                    <div class="unique-summary-value fw-bold fs-4 text-dark">{{ $summary['hours'] ?? '0:00' }}</div>
