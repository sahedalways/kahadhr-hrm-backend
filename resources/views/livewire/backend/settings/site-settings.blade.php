        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="fw-500 mb-0 text-primary">Site Settings</h5>
                    <hr>
                                ...
                                @error('logo')
                                    <span class="text-danger mt-1 d-block"
                                        ...
                                        @if (str_contains($message, 'failed to upload'))
                                            <strong>Image size is too large!</strong> Maximum allowed is 3MB.
                                        @else
                                            {{ $message }}
                                        @endif
                                    </span>
                                ...
                                <div class="mt-2">
                                    ...
                                    @elseif($old_logo)
                                        <img src="{{ $old_logo }}"
                                             ...
                                             width="120">
                                    @else
                                        <img src="https://via.placeholder.com/120x80?text=No+Logo"
                                             class="img-thumbnail"
                                             width="120">
                                    @endif
                                </div>
