<div class="flex-grow-1 schedule-grid-container">
    ...
    <div class="modal fade" id="shiftDetailsModal-{{ $employee['id'] }}-{{ \Str::slug($content['title']) }}"
        tabindex="-1" aria-hidden="true" wire:ignore.self data-bs-backdrop="static" data-bs-keyboard="false">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <strong>Time:</strong>
                                <span class="ms-1">{{ $content['time'] ?? '-' }}</span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <strong>Address:</strong>
                                <span class="ms-1">{{ $content['shift']['address'] ?? '-' }}</span>
                            </div>
                        </div>
                    </div>
...
@if ($showAddShiftPanel)
    <div class="shift-panel-overlay" wire:click="closeAddShiftPanel">
        <div class="shift-panel" wire:click.stop>
            ...
            {{-- HEADER --}}
            <div class="shift-panel-header d-flex align-items-center justify-content-between px-4 py-3 border-bottom">
                        ...
                        <div class="row align-items-center g-2 mb-3 shift-form-row">
                            ...
                            <div class="col-9">
                                <input type="text" id="shiftTitleInput" wire:model.defer="newShift.title"
                                    class="form-control form-control-sm" placeholder="Enter shift title…" required>
            ...
            @if ($isShiftTempTab == false)
                <div class="shift-panel-footer d-flex align-items-center px-4 py-3 border-top bg-white">
                    ...
                    <div class="d-flex gap-2 ms-auto">
                        <div class="d-flex gap-2 ms-auto">
                            <button class="btn btn-light" wire:click="saveAsTemplate" wire:loading.attr="disabled"
                                wire:target="saveAsTemplate" data-bs-toggle="tooltip" data-bs-placement="top"
