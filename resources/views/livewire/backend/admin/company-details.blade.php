                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="list-group list-group-flush" role="tablist">
                            ...
                            <a class="list-group-item list-group-item-action active py-3 px-4 fw-semibold border-0"
                                ...
                                aria-selected="true" style="border-left: 4px solid var(--bs-primary) !important;">
                            ...
                            <a class="list-group-item list-group-item-action py-3 px-4 fw-semibold border-0 "
                                data-bs-toggle="tab" href="#billing" role="tab" aria-controls="billing"
                                aria-selected="false">
                                <i class="bi bi-receipt me-3 fs-5"></i> Billing / Subscription
                            </a>

                            <a class="list-group-item list-group-item-action py-3 px-4 fw-semibold border-0"
                                data-bs-toggle="tab" href="#bankinfo" role="tab" aria-controls="bankinfo"
                                aria-selected="false">
                                <i class="bi bi-credit-card-2-front me-3 fs-5"></i> Payment Info
                            </a>

                            <a class="list-group-item list-group-item-action py-3 px-4 fw-semibold border-0"
                                data-bs-toggle="tab" href="#employees" role="tab" aria-controls="employees"
                                aria-selected="false">
                                <i class="bi bi-people me-3 fs-5"></i> Employees
                            </a>

                            <a class="list-group-item list-group-item-action py-3 px-4 fw-semibold border-0"
                                data-bs-toggle="tab" href="#settingsItem" role="tab" aria-controls="settingsItem"
                                aria-selected="false"
                    ...
                    <div class="tab-pane fade" id="billing">
                        ...
                        @if (isset($details->subscription_status) && $details->subscription_status === 'active') bg-success-subtle border border-success @else bg-warning-subtle border border-warning @endif">
                            ...
                            fs-7 py-1 px-2 fw-bold">
                                ...
                                <form id="invoiceFilterForm" method="GET" class="row g-2 mb-3">
                                    <div class="col-md-4">
                                        <input type="text" name="search" value="{{ request('search') }}"
                                            class="form-control form-control-sm" placeholder="Search by Invoice #">
                                    </div>
                                    <div class="col-md-3">
