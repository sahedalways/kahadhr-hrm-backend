        ...
        <div class="p-2 border rounded d-flex flex-wrap align-items-center gap-2"
            ...
            @foreach ($this->selectedShiftEmployees as $employee)
                ...
                <div class="d-flex align-items-center {{ $isOnLeave ? 'bg-secondary' : 'bg-primary' }} text-white rounded-pill px-2 py-1"
                    ...
                    @unless ($isOnLeave)
                        <button type="button"
                                class="btn btn-sm btn-transparent p-0 text-white ms-auto"
                                wire:click="removeEmployeeFromShift({{ $employee->id }})"
                                aria-label="Remove">
            ...
            <button type="button"
                    ...
                    x-text="showAddPanel ? 'Cancel' : '+ Add'">
            </button>
                ...
                <div class="card card-body p-0 shadow-sm">
                    <div class="input-group input-group-sm shift-employee-list">
                        ...
                        <span class="input-group-text">
                            <i wire:loading
                               wire:target="shiftEmployeeSearch"
