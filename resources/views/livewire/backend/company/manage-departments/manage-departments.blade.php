<div>
    <div class="row align-items-center justify-content-between mb-4">
        ...
        <!-- LEFT: Title -->
        <div class="col-auto">
            <h5 class="fw-500 text-primary m-0">Departments Management</h5>
        </div>

        <!-- RIGHT: Export Buttons -->
        <div class="col-auto d-flex gap-2">
            <button wire:click="exportDepartments('pdf')" class="btn btn-sm btn-white text-primary">
                <i class="fa fa-file-pdf me-1"></i> PDF
            </button>

            <button wire:click="exportDepartments('excel')" class="btn btn-sm btn-white text-success">
                <i class="fa fa-file-excel me-1"></i> Excel
            </button>

            <button wire:click="exportDepartments('csv')" class="btn btn-sm btn-white text-info">
        ...
        <div class="col-auto">
            <a data-bs-toggle="modal" data-bs-target="#add" wire:click="resetInputFields"
                ...
                <i class="fa fa-plus me-2"></i> Add New Department
            </a>
        </div>
    </div>
...
<script>
    Livewire.on('confirmDelete', departmentId => {
        if (confirm("Are you sure you want to delete this department? This action cannot be undone.")) {
            Livewire.dispatch('deleteDepartment', {
                id: departmentId
            });
        }
    });
