...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-body">
            <h2>Employee Signed a Document</h2>

            <p>Hello {{ $company->company_name ?? 'Company' }},</p>

            <p>The following document has been signed by an employee:</p>

            <div class="document-info">
                <p><strong>Document Name:</strong> {{ $document->name ?? 'N/A' }}</p>
                <p><strong>Signed By:</strong> {{ $employee->full_name ?? 'N/A' }}</p>
                <p><strong>Date Signed:</strong> {{ $document->updated_at->format('d M Y, H:i') }}</p>
            </div>

            <p>You can check the document in the portal for more details.</p>

            <p>If you did not expect this action, please review immediately.</p>
