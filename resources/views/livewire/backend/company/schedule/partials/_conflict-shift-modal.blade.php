        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @php
                    ...
                    foreach ($conflictData as $date => $shifts) {
                        $formattedDate = \Carbon\Carbon::parse($date)->format('j M Y');

                        foreach ($shifts as $shift) {
                            if ($shift->dates && $shift->dates->isNotEmpty()) {
                                foreach ($shift->dates as $shiftDate) {
                                    if ($shiftDate->date == $date) {
                                        foreach ($shiftDate->employees as $emp) {
                                            $dateEmployees[$formattedDate][$emp->id] = $emp->full_name;
                                        }
                                    }
                                }
                            }
                ...
                <ul class="list-unstyled mb-0">
                    @forelse ($dateEmployees as $date => $names)
                        <li>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-danger"
                    ...
                    <span wire:loading.remove
                          wire:target="confirmOverwrite">Confirm & Replace</span>
                    <span wire:loading
                          wire:target="confirmOverwrite">
