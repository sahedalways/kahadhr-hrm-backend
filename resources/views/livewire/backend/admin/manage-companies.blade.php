<div>
   ...
   "
                    ...
                    @php
                        ...
                        $formerCount = $infos->where('is_active', 'Inactive')->count();
                    @endphp
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea class="form-control"
                                          rows="2"
                                          wire:model="address_contact_info"></textarea>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select class="form-control"
                                        wire:model="subscription_status">
